...
<head><base href="../../../../">
    ...
    <link href="{{asset('assets/css/pages/login/classic/login-5.css?v=7.0.3')}}" rel="stylesheet" type="text/css" />
...
<script src="{{asset('assets/js/pages/custom/login/login-general.js?v=7.0.3')}}"></script>
<!--end::Page Scripts-->
</body>
<!--end::Body-->
</html>
