        ...
        <div class="d-flex align-items-stretch mr-3">
            ...
            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                ...
                <div id="kt_header_menu"
                    ...
                    <!--begin::Header Nav-->
                    <ul class="menu-nav">
                        <li @if ($pageSlug === 'dashboard') @endif class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here"
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">Recurring Invoice</span>
                                        </a>
                                    </li>
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">Receive Money</span>
                                        </a>
                                    </li>
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">Good Receiving</span>
                                        </a>
                                    </li>
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">Journal Entry</span>
                                        </a>
                                    </li>
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">Bank Deposit</span>
                                        </a>
                                    </li>
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">Funds Transfer</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="#" class="menu-link">
                                            ...
                                            <span class="menu-text">Other Collections</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="#" class="menu-link">
                                            ...
                                            <span class="menu-text">Other Payments</span>
                                            <span class="menu-label">
																</span>
                                        </a>
                                    </li>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">Transfer In</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <ul class="menu-content">
                                            ...
                                            <ul class="menu-inner">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="#" class="menu-link">
                                                        ...
                                                        <span class="menu-text">Sales Persons</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="#" class="menu-link">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="#" class="menu-link">
                                                        ...
                                                        <span class="menu-text">Other Contacts</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                            ...
                                            <ul class="menu-inner">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="#" class="menu-link">
                                                        ...
                                                        <span class="menu-text">Customer Categories</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="#" class="menu-link">
                                                        ...
                                                        <span class="menu-text">Contact Categories</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="#" class="menu-link">
                                                        ...
                                                        <span class="menu-text">Vendor Categories</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="#" class="menu-link">
                                            ...
                                            <ul class="menu-inner">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="#" class="menu-link">
                                                        ...
                                                        <span class="menu-text">Adjustment Types</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="#" class="menu-link">
                                        ...
                                        <li class="menu-item">
                                            <h3 class="menu-heading menu-toggle">
                                                ...
                                                <span class="menu-text">Sales Geography</span>
                                                <i class="menu-arrow"></i>
                                            </h3>
                                            <ul class="menu-inner">
                                                <li class="menu-item" aria-haspopup="true">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="#" class="menu-link">
                                                        ...
                                                        <span class="menu-text">Territories</span>
                                                        <span class="menu-label">
																			</span>
                                                    </a>
                                                </li>
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="#" class="menu-link">
                                                        ...
                                                        <span class="menu-text">Sub Areas</span>
                                                        <span class="menu-label">
																			</span>
                                                    </a>
                                                </li>
